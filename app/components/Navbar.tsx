      ...
      <div className="container mx-auto px-4 lg:px-6">
        <div className="flex justify-between items-center h-14 lg:h-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            {totalPrice > 0 && (
              <button className="flex items-center space-x-2 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 hover:from-blue-700 hover:via-purple-700 hover:to-pink-600 text-white px-4 py-2.5 rounded-2xl font-medium transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-purple-500/25 text-sm">
