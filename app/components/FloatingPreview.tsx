      ...
      <div className={`lg:hidden fixed top-14 left-0 right-0 z-50 bg-white border-b border-slate-200 shadow-xl transition-all duration-300 ${
        ...
        <div className="px-4 py-3">
          ...
          <div className="w-full mb-3">
            <div className="w-full h-32 rounded-lg overflow-hidden border border-slate-200 shadow-sm cursor-pointer hover:shadow-md transition-shadow"
          ...
          <div className="w-full">
            <h3 className="text-sm font-bold text-slate-800 truncate">{material.name}</h3>
